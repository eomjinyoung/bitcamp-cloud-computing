...
public class Exam11_3 {
    ...
    //    http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test01
    // => http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test02
    ...
    // => 세션 객체를 먼저 준비하기 위해 test01()을 먼저 호출해야 한다.
    //    http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test01
    // => http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test03?name=홍길동&age=xx
    //
    ...
    // => 세션 객체를 먼저 준비하기 위해 test01()을 먼저 호출해야 한다.
    //    http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test01
    // => http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test04
    ...
    //     
    // 테스트
    // => http://localhost:8080/java106-spring-webmvc/mvc/exam11_3/test05
